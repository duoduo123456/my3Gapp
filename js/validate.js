define([],function(){
	...
	validate.verifyCode=function(value){
    ...
    validate.imageVerifyCode=function(value){
        var reg=/^\d{4}$/;
        if(!reg.test(value)){
            return false;
        }
    ...
    validate.phoneNumber=function(value){
        var reg=/^1[34578]\d{9}$/;
        if(!reg.test(value)){
            return false;
        }
    ...
    validate.idName=function(value){
    ...
    validate.idAddress=function(value){
        var reg=/^[\u4e00-\u9fa5\w]+$/;
        if(!reg.test(value)){
            return false;
        }
